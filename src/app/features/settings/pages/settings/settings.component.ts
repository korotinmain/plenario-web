                ...
                @for (p of user()!.providers; track p) {
                  @if (p === 'google') {
                    <span class="provider-chip provider-chip--google">
                      <svg class="provider-chip__icon" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="provider-chip provider-chip--email">
                      <mat-icon class="provider-chip__icon provider-chip__icon--mat">email</mat-icon>
                      Email & Password
                    </span>
                  }
                }
          ...
          @if (hasCredentials()) {
            ...
            <div class="security-notice">
              ...
              <div>
                ...
                <p class="security-notice__desc">Your account uses Google sign-in. Password management is not applicable.</p>
              </div>
            </div>
          }
        </div>
