...
@Component({
  ...
  template: `
    <app-page-header
      title="Today"
      [subtitle]="(today | date: 'EEEE, MMMM d') ?? undefined"
    />
    <div class="coming-soon-card">
      ...
      <p class="cs-desc">See all tasks due today, across every project, in one focused view. Coming in Increment 5.</p>
    </div>
  `,
  styles: [`
    .coming-soon-card {
    ...
    .cs-icon-ring { padding: 6px; border-radius: 24px; background: rgba(16,185,129,0.06); margin-bottom: 24px; }
    .cs-icon-wrap {
    ...
    .cs-icon { font-size: 28px; width: 28px; height: 28px; color: #059669; }
